...
import {Button, ButtonDisabled,CounterLeft, PortraitContainer, NameContainer, AliasContainer, CounterExcess, CloseWindowSmall} from '../Elements/ElementsFormulary'
...
const MessageBoxAccountBar = ({messageFloating, user, currentUserInfo, addToTimelineFloating, message, handleChange, changeShowMessageBox}) => {
      const LettersLeft = 20;

      return ( 
      <MessageContainer>
            <CloseWindowSmall onClick={()=>changeShowMessageBox(false)} >X</CloseWindowSmall>
            <CreateMessageForm onSubmit={addToTimelineFloating}>
                  <HeaderUser>
                        <PortraitContainer>
                        {user.photoURL ?
...
export default MessageBoxAccountBar;